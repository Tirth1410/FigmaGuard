...
export default function TestingProcess() {
  const steps = [
    ...
    },
    {
      ...
      description: "Enter the URL of your Figma design or web application to be tested.",
    },
    {
      icon: <Code className="h-8 w-8 text-[#6A5ACD]" />,
      title: "Automated Testing",
      description: "Our system generates test cases and runs automated tests using Selenium/Playwright.",
    },
    {
